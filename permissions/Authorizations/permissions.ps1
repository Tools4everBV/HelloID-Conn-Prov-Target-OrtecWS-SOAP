#################################################################
# HelloID-Conn-Prov-Target-OrtecWS-SOAP-Permissions-Authorization
# PowerShell V2
#################################################################
...
try {
    ...
    Write-Information 'Creating HelloID_GetAuthorization Xml body'
    ...
    $retrievedPermissions = $helloID_GetAuthorizationsResponse.roles.role
