#####################################################################
# HelloID-Conn-Prov-Target-OrtecWS-SOAP-GrantPermission-Authorization
# PowerShell V2
#####################################################################
...
try {
    ...
    switch ($lifecycleProcess) {
        'GrantPermission' {
            ...
            if (-not($actionContext.DryRun -eq $true)) {
                Write-Information "Granting Ortec-WS permission: [$($actionContext.PermissionDisplayName)] - [$($actionContext.References.Permission.Reference)]"
                ...
                Write-Information "[DryRun] Grant Ortec-WS permission: [$($actionContext.PermissionDisplayName)] - [$($actionContext.References.Permission.Reference)], will be executed during enforcement"
            }
    ...
    $outputContext.success = $false
    $ex = $PSItem
    $auditLogMessage = "Could not grant Ortec-WS permission for account: [$($actionContext.References.Account)]. Error: $($_.Exception.Message)"
